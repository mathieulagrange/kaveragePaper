...
large scale kkmeans 
sampling \cite{Chitta:2011:AKK:2020408.2020558}
block storing of the similarity matrix
coarsening \cite{Kulis2008}

We introduce in this paper a hard clustering algorithm based on a connectivity model that has the following properties: 
1) it may consider as input arbitrary symmetric similarity matrices,
2) it has fast and guaranteed convergence, 3) it guaranties a low number of object to clusters reallocations and 4) provides good
