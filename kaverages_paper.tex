...
For those reasons and ease of reading, only the NMI is considered. Though, it shall be noted that the most of statements that will be made in the following in terms of ranking of the different algorithms  still holds while considering the accuracy as reference, see \url{} for full results.
