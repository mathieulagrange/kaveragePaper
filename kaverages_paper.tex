...
\begin{table}
\begin{center}
\caption{Performance averaged over the 47 datasets. The NMI is expressed in percents and the computation time in seconds.}
