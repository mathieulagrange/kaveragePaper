...
\caption{Average computation time of the kernel k-means (*) and kaverages (o) algorithms with 2 GB (solid line) and 32 GB (dashed line) of main memory.}
\end{figure}
