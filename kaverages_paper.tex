...
\begin{figure}
\center
\includegraphics[width = .7 \textwidth]{figures/iterMove.png} 
...
\begin{figure}
\center
\includegraphics[width = .7 \textwidth]{figures/sampleMove.png} 
...
For those reasons and ease of reading, only the NMI is considered in thisa paper, as in (\cite{Kulis2008}). However, it shall be noted that most of the statements that will be made in the following in terms of performance ranking of the different algorithms  still holds true while considering the accuracy metric as reference.
...
id & nb. classes & nb. objects & k-means & kernel k-means & k-averages \\ 
